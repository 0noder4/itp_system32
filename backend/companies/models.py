...
class Company(models.Model):
    ...
    representative = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete = models.CASCADE, null=True, related_name ="comp_repr") 
    fr_resp = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null = True, related_name ="fr_resp") 
...
class Exhibitor(Person):
    form = models.ForeignKey(Form, on_delete=models.CASCADE, related_name = "exhibitors")
